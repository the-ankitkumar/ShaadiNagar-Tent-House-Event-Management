...
function BigServiceCard({ title, description, linkText, image }) {
  return (
    <div className="relative flex overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-black/5 h-72 md:h-80">
      {/* Text side */}
...
function SmallServiceCard({ title, description, linkText, icon }) {
  return (
    <div className="flex flex-col justify-between rounded-2xl bg-white p-6 shadow-sm ring-1 ring-black/5 h-full">
    ...
    <section className="w-full bg-neutral-50 py-12 px-4 md:px-10">
      <div className="mx-auto max-w-6xl">
        ...
        <p className="mt-2 text-neutral-600">
          Start planning with us, it&apos;s free!
        </p>
