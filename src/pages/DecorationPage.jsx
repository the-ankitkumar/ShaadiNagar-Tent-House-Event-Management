...
import img1 from "../assets/WEDDING DECORATION.jpg";
import img2 from "../assets/EntryGate_Decoration(image1).jpg";
import img3 from "../assets/EntryGate_Decoration(image 2)..jpg";
import img4 from "../assets/menhdi decoration(image 1).jpg";
import img5 from "../assets/Indian Wedding Mandap Decor.jpg";
import img6 from "../assets/Royal Hindu Wedding Mandap Stage Decor.jpg";
import img7 from "../assets/Royal Mughal Wedding Stage Decoration.jpg";
import img8 from "../assets/Indian Wedding Haldi (image1).jpg";
import img9 from "../assets/Indian Wedding Haldi (image2).jpg";
import img10 from "../assets/wedding (image 1).jpg";
import img11 from "../assets/wedding (image 2).jpg";
...
export default function DecorationPage() {
  ...
  return (
    <section id="decoration" className="w-full bg-neutral-50 py-10 px-4 md:px-10">
